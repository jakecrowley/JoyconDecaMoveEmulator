...
namespace Joycon4CS
{
	...
	public class Joycon
	{
		...
		{
			return Vector3.LookRotation(new Vector3(j_b.X, i_b.X, k_b.X), -(new Vector3(j_b.Z, i_b.Z, k_b.Z)));
		}
